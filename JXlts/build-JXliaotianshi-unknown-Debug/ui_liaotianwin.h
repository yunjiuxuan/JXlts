...
public:
    ...
    void setupUi(QWidget *liaotianWin)
    {
        ...
        liaotianWin->setEnabled(true);
        liaotianWin->resize(854, 648);
        liaotianWin->setAutoFillBackground(true);
        ...
        progressBar->setGeometry(QRect(30, 430, 491, 25));
    ...
    void retranslateUi(QWidget *liaotianWin)
    {
        ...
        dateEdit->setDisplayFormat(QApplication::translate("liaotianWin", "yyyy-MM-dd", nullptr));
        send->setText(QApplication::translate("liaotianWin", "\345\217\221\n"
"\351\200\201", nullptr));
        sendFile->setText(QApplication::translate("liaotianWin", "\346\226\207\n"
"\344\273\266", nullptr));
        cancel->setText(QApplication::translate("liaotianWin", "\345\217\226\n"
"\346\266\210", nullptr));
    } // retranslateUi
